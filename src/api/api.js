...
export const PriceQuotations = {
  ...
  getSuppliers: "/api/PriceQuotations/GetSuppliersCanWorkInPriceQuotation",
  getReport: "/api/PriceQuotations/GetAllPriceQuotationsReport",
  getReportExport: "/api/PriceQuotations/ExportReportPriceQuotation",
  getReportBill: "/api/PriceQuotations/ExportPriceQuotationBill",
  getReportSalesStatistics:
    "/api/PriceQuotations/GetPriceQuotationSalesStatisticsReport",
  add: "/api/PriceQuotations/AddPriceQuotationJson",
  update: "/api/PriceQuotations/UpdatePriceQuotationDetalis",
  updateDateTime: "/api/PriceQuotations/UpdatePriceQuotationDateTime",
  sendToClient: "/api/PriceQuotations/SendPriceQuotationToClient",
  resend: "/api/PriceQuotations/ResendPriceQuotations",
  resendToMany: "/api/PriceQuotations/ResendOnePriceQuotationsToMany",
  moveToWaitingForSupplier:
    "/api/PriceQuotationHistoryWorks/MoveToWaitingForSupplierPriceQuotations",
  moveToApproved:
...
export const PriceQuotationDetails = {
  ...
  sendRequest: "/api/PriceQuotationDetails/SendRequestProductItemReport",
  exportRequest: "/api/PriceQuotationDetails/ExportRequestProductItemReport",
};
export const QuotationDetailsHistoryWorks = {
  ...
  moveToAcceptedByCustomer:
    "/api/QuotationDetailsHistoryWorks/MoveQuotationDetailsToAcceptedByCustomer",
...
export const PriceQuotationJobOrders = {
  ...
  getReportBill: "/api/PriceQuotations/ExportPriceQuotation(L.P.O)",
  ...
  getCusomersClosedJobReport:
    "/api/PriceQuotationJobOrders/GetCusomersClosedJobReport?",
  getStaffAchievementsReport:
    "/api/PriceQuotationJobOrders/GetStaffAchievementsReport?",
  getReportExport: "/api/PriceQuotationJobOrders/ExportJobOrderReport",
...
export const JobOrderStagesOfWorks = {
  getAll: "/api/PriceQuotationJobOrderStagesOfWorks/GetAllJobOrderStagesOfWork",
  getDetails:
    "/api/PriceQuotationJobOrderStagesOfWorks/GetJobOrderStagesOfWorkDetails",
  add: "/api/PriceQuotationJobOrderStagesOfWorks/AddJobOrderStagesOfWork",
  finish: "/api/PriceQuotationJobOrderStagesOfWorks/FinishJobOrderStage",
  cancle: "/api/PriceQuotationJobOrderStagesOfWorks/CancleFinishJobOrderStage",
  deleteStage:
    "/api/PriceQuotationJobOrderStagesOfWorks/DeleteJobOrderStagesOfWork",
};

export const JobOrderStages = {
  getAll: "/api/JobOrderStages/GetAllJobOrderStages",
  getDetails: "/api/JobOrderStages/GetJobOrderStageDetails",
  getDialog: "/api/JobOrderStages/GetJobOrderStageDialog",
  add: "/api/JobOrderStages/AddJobOrderStage",
  update: "/api/JobOrderStages/UpdateJobOrderStage",
  changeActivationType: "/api/JobOrderStages/ChangeActivationTypeJobOrderStage",
  finalDelete: "/api/JobOrderStages/DeleteJobOrderStage",
  deleteImage: "/api/JobOrderStages/DeleteImage",
};

export const WorkFields = {
  getAll: "/api/WorkFields/GetAllWorkFields",
  getDetails: "/api/WorkFields/GetWorkFieldDetails",
  getDialog: "/api/WorkFields/GetWorkFieldDialog",
  add: "/api/WorkFields/AddWorkField",
  update: "/api/WorkFields/UpdateWorkField",
  changeActivationType: "/api/WorkFields/ChangeActivationTypeWorkField",
  finalDelete: "/api/WorkFields/DeleteWorkField",
  deleteImage: "/api/WorkFields/DeleteImage",
};
...
export const UserInterests = {
  update: "/api/UserInterests/UpdateAndGetUserInterests",
};
...
export const EmailTemplates = {
  getAll: "/api/EmailTemplates/GetAllEmailTemplates",
};
//#endregion EmailTemplates

//#region CompanyMarks
export const CompanyMarks = {
  getDialog: "/api/CompanyMarks/GetCompanyMarkDialog",
};
//#endregion CompanyMarks

//#region PoliciesAndTerms
export const PoliciesAndTerms = {
  getAll: "/api/PoliciesAndTerms/GetAllPoliciesAndTerms",
  getDialog: "/api/PoliciesAndTerms/GetPoliciesAndTermDialog",
};
