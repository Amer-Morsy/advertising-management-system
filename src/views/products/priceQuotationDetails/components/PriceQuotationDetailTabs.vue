...
import {
  ...
  hasPriceQuotationDetailAcceptedByCustomer,
...
import imgAcceptedByCustomer from "@/assets/images/PriceQuotations_FinishJobOrderCustomerReceive.svg";
...
export default {
  ...
  computed: {
    theOptions() {
      ...
      if (checkPrivilege(hasPriceQuotationDetailAcceptedByCustomer())) {
        tabOptions.push({
          itemToken: QUOTATION_DETAILS_HISTORY_WORK_TYPES.AcceptedByCustomer,
          itemName: this.$t(
            "QuotationDetailsHistoryWorkType.AcceptedByCustomer"
          ),
          itemImagePath: imgAcceptedByCustomer,
          currentTab: "AcceptedByCustomer",
          count: this.statistics.totalAcceptedByCustomer,
        });
      }
  ...
  methods: {
    ...
    setCurrentTab() {
      ...
      else if (checkPrivilege(hasPriceQuotationDetailAcceptedByCustomer()))
        this.currentTab = "AcceptedByCustomer";
