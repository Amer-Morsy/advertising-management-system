      ...
      <tbody>
        ...
        <template v-else>
          <tr v-for="(item, index) in StoreItems" :key="index">
            ...
            <!-- <td v-if="id == 'add'">{{ isDataExist(item.storeItemName) }}</td> -->
            <td v-if="!item.storeItemInfoData">
              {{ isDataExist(item.storeItemName) }}
            </td>
            <td v-else>
              {{ isDataExist(item.storeItemInfoData.storeItemNameCurrent) }}
            </td>
            <td>
              <CustomInputInt
            ...
            <td>
              <TextArea
                ...
                :withOutDesign="true"
              />
              <!-- <span v-else>{{ item.priceQuotationDetalisNotes }}</span> -->
            </td>
            <td>
              <CustomSelectBox
...
export default {
  props: ["StoreItems", "id", "isDisabled"],
