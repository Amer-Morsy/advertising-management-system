<template>
  <div>
    ...
    <CustomBottomSheet
      ...
      :clickToClose="false"
      :swipeAble="false"
      @opened="updateSheetOpened = true"
      @closed="updateSheetOpened = false"
    >
      <PriceQuotationJobOrderForm
        v-if="!isLoading"
        id="update"
        :priceQuotationJobOrder="priceQuotationJobOrder"
        :updateSheetOpened="updateSheetOpened"
...
export default {
  ...
  methods: {
    async updatePriceQuotationJobOrder() {
      this.isLoading = true;
      this.priceQuotationJobOrder.priceQuotationToken =
        this.priceQuotationJobOrder.priceQuotationInfoData.priceQuotationToken;
