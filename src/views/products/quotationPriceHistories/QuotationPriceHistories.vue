  ...
  <div class="">
    ...
    <div class="app-content pagination-with-content">
      ...
      <QuotationPriceHistoryAdd
        ...
        :storeItemQuantity="priceQuotation.storeItemQuantity"
...
export default {
  ...
  methods: {
    async getDetails() {
      ...
      try {
        let response;
        if (this.priceQuotationDetailsToken) {
          let filter = { token: this.priceQuotationDetailsToken };
          this.priceQuotation.setInitialValue();
          response = await apiPriceQuotationDetails.getDetails(filter);
        } else {
          let filter = { token: this.storeItemToken };
          this.storeItem.setInitialValue();
          response = await apiStoreItems.getDetails(filter);
        }
  ...
  async created() {
    ...
    this.quotationPriceHistories.filterData.storeItemToken =
      this.storeItemToken;
