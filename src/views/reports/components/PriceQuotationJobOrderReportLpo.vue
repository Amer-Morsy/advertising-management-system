<template>
  <CustomBottomSheet
    :refName="'PriceQuotationJobOrderReportLpo'"
    size="xl"
    :headerText="$t('PriceQuotationJobOrders.lpo')"
  ...
  >
    ...
    <div class="form-actions">
      ...
      <div
        @click.prevent="closeBottomSheet('PriceQuotationJobOrderReportLpo')"
        class="icon-cancel"
      >
...
export default {
  ...
  methods: {
    async getDialogs() {
      this.priceQuotationJobOrders.filterData.setInitialValue();
    ...
    async getReportTemplatesDialog() {
      ...
      this.reportTemplateTokenOptions = await getReportTemplatesDialog({
        reportTemplateTypeToken: REPORT_TEMPLATE_TYPES.Lpo,
      });
      ...
      if (
        ...
        try {
          ...
          if (response.data.status == STATUS.SUCCESS) {
            ...
            this.closeBottomSheet("PriceQuotationJobOrderReportLpo");
