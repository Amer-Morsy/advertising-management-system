    ...
    <form autocomplete="off">
      ...
      <template v-if="educationalGroup.fixedScheduleStatus">
        <CustomSelectBoxMultiple
          :className="'col-md-12'"
          :id="`addStudents-fixedScheduleDays`"
              ...
              <template v-else>
                ...
                >
                  ...
                  <div class="row">
                    ...
                    <CustomCheckbox
                      :value="groupTime.maximumNumberOfStudentsStatus"
                      v-on:changeValue="
                        groupTime.maximumNumberOfStudentsStatus = $event
                      "
                      :title="
                        $t('EducationalGroups.maximumNumberOfStudentsStatus')
                      "
                      class="col-md-6"
                    />
                    <CustomInputInt
                      :className="'col-md-6'"
                      :id="`${id}-[fixed][${indexPlace}][${indexGroupTime}][maximumNumberOfStudents]`"
                      :value="groupTime.maximumNumberOfStudents"
                      v-on:changeValue="
                        groupTime.maximumNumberOfStudents = $event
                      "
                    ...
                    <CustomCheckbox
                      :value="groupTime.minimumNumberOfStudentsStatus"
                      v-on:changeValue="
                        groupTime.minimumNumberOfStudentsStatus = $event
                      "
                      :title="
                        $t('EducationalGroups.minimumNumberOfStudentsStatus')
                      "
                      class="col-md-6"
                    />
                    <CustomInputInt
                      :className="'col-md-6'"
                      :id="`${id}-[fixed][${indexPlace}][${indexGroupTime}][minimumNumberOfStudents]`"
                      :value="groupTime.minimumNumberOfStudents"
                      v-on:changeValue="
                        groupTime.minimumNumberOfStudents = $event
                      "
                    ...
                    >
                      ...
                      <div class="row">
                        ...
                        <CustomCheckbox
                          ...
                          :title="
                            $t(
                              'EducationalGroups.maximumNumberOfStudentsStatus'
                            )
                          "
                          class="col-md-6"
                        />
                        <CustomInputInt
                          :className="'col-md-6'"
                          :id="`${id}-[${index}][${indexPlace}][${indexGroupTime}][maximumNumberOfStudents]`"
                          :value="groupTime.maximumNumberOfStudents"
                          v-on:changeValue="
                            groupTime.maximumNumberOfStudents = $event
                          "
                          :title="
                            $t('EducationalGroups.maximumNumberOfStudents')
                          "
                          :imgName="'number.svg'"
                        />
                        ...
                        <CustomCheckbox
                          ...
                          :title="
                            $t(
                              'EducationalGroups.minimumNumberOfStudentsStatus'
                            )
                          "
                          class="col-md-6"
                        />
                        <CustomInputInt
                          :className="'col-md-6'"
                          :id="`${id}-[${index}][${indexPlace}][${indexGroupTime}][minimumNumberOfStudents]`"
                          :value="groupTime.minimumNumberOfStudents"
                          v-on:changeValue="
                            groupTime.minimumNumberOfStudents = $event
                          "
                          :title="
                            $t('EducationalGroups.minimumNumberOfStudents')
                          "
                          :imgName="'number.svg'"
                        />
