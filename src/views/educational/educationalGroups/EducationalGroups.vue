  ...
  computed: {
    ...
    activationTypesTokensOptions: function () {
      ...
      if (checkPrivilege(hasEducationalGroupViewActive())) {
        ...
        obj.totalNumber =
          this.educationalGroups.activationStatistics.totalActiveCount || 0;
        if (obj) arr.push(obj);
      }
      if (checkPrivilege(hasEducationalGroupViewArchive())) {
        ...
        obj.totalNumber =
          this.educationalGroups.activationStatistics.totalArchivedCount || 0;
        if (obj) arr.push(obj);
      }
      if (checkPrivilege(hasEducationalGroupViewBlocked())) {
        ...
        obj.totalNumber =
          this.educationalGroups.activationStatistics.totalBlockedCount || 0;
        if (obj) arr.push(obj);
      }
      return arr;
    },
