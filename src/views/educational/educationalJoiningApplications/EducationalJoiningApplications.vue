  ...
  <div class="">
    ...
    <div class="app-content pagination-with-content">
      ...
      <template v-if="hasData">
        ...
        <EducationalJoiningApplicationChangeApprove
          :educationalJoiningApplication="
            educationalJoiningApplications.educationalJoiningApplication
          "
          v-on:refresh="getAllEducationalJoiningApplications()"
...
import EducationalJoiningApplicationChangeApprove from "./components/EducationalJoiningApplicationChangeApprove.vue";
