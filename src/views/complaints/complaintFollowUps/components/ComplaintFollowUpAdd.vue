  ...
  methods: {
    setComplaintFollowUpData(complaint) {
      let complaintInfoData = {
        ...
        complaintImageIsDefault: complaint.complaintImageIsDefault,
        complaintImagePath: complaint.complaintImagePath,
        complaintImageSizeBytes: complaint.complaintImageSizeBytes,
        complaintImageSizeTextCurrent: complaint.complaintImageSizeTextCurrent,
      };
      let dataInt = {
