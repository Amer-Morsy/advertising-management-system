  ...
  <div v-if="complaintsData" class="table-container">
    <table class="my-table">
      <thead>
        <tr>
          <th rowspan="2">#</th>
          <th colspan="7">{{ $t("Complaints.data") }}</th>
          <th colspan="3">
        ...
        <tr>
          ...
          <th>{{ $t("Complaints.complainingPersonUser") }}</th>
        ...
        <tr v-for="(complaint, index) in complaintsData" :key="index">
          ...
          <td>
            <img
              ...
              :src="
                fullPathFileFromServer(complaint.complaintImagePath, defaultImg)
              "
          ...
          <td>
            {{ isDataExist(complaint.complaintStatusTypeNameCurrent) }}
          </td>
          <td>
            {{
              isDataExist(
