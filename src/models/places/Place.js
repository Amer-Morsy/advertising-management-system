...
import WorkFieldInfoData from "./../settings/settingsOthers/workFields/WorkFieldInfoData";
...
export default class Place extends BaseEntityModel {
  ...
  setInitialValue(placeTypeToken = "") {
    ...
    this.workFieldToken = "";
    this.workFieldInfoData = new WorkFieldInfoData();
  ...
  fillData(data) {
    if (data) {
      ...
      this.workFieldInfoData.fillData(data.workFieldInfoData);
