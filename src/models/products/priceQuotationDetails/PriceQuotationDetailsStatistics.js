export default class PriceQuotationsStatistics {
  ...
  setPriceQuotationsStatisticsInitialValue() {
    ...
    this.totalAcceptedByCustomer = 0;
    this.acceptedByCustomerPercentage = 0;
    this.acceptedByCustomerPercentageText = "";
  ...
  fillPriceQuotationsStatisticsData(data) {
    if (data) {
      ...
      this.totalAcceptedByCustomer = data.totalAcceptedByCustomer ?? 0;
      this.acceptedByCustomerPercentage =
        data.acceptedByCustomerPercentage ?? 0;
      this.acceptedByCustomerPercentageText =
        data.acceptedByCustomerPercentageText ?? "";
