...
export default class PriceQuotationDetail extends BaseEntityModel {
  ...
  setInitialValue() {
    ...
    this.storeItemToken = "";
    this.canMoveToWorkProsess = false;
    this.priceQuotationDetailsNotes = "";
    this.storeItemQuantity = "";
    this.approvedPriceTotalItems = 0;
    this.approvedPriceTotalItemsText = "";
    this.approvedPriceTotalItemsWithCurrency = "";
  ...
  fillData(data) {
    if (data) {
      ...
      this.canMoveToWorkProsess = data.canMoveToWorkProsess ?? false;
      this.priceQuotationDetailsNotes = data.priceQuotationDetailsNotes ?? "";
      this.storeItemQuantity = data.storeItemQuantity ?? "";
      this.approvedPriceTotalItems = data.approvedPriceTotalItems ?? 0;
      this.approvedPriceTotalItemsText = data.approvedPriceTotalItemsText ?? "";
      this.approvedPriceTotalItemsWithCurrency =
        data.approvedPriceTotalItemsWithCurrency ?? "";
