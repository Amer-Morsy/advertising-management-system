...
export default class PriceQuotation extends BaseEntityModel {
  ...
  setInitialValue() {
    ...
    this.priceQuotationDateTime = "";
    this.priceQuotationDateTimeCustomized = "";
    this.priceQuotationDate = "";
    this.priceQuotationTime = "";
    this.feeTypeToken = "";
    ...
    this.requestUserClientToken = "";
    this.requestUserClientInfoData = new UserInfoData();
  ...
  fillData(data) {
    if (data) {
      ...
      this.priceQuotationDateTime = data.priceQuotationDateTime ?? "";
      this.priceQuotationDateTimeCustomized =
        data.priceQuotationDateTimeCustomized ?? "";
      this.priceQuotationDate = data.priceQuotationDate ?? "";
      this.priceQuotationTime = data.priceQuotationTime ?? "";
      ...
      this.requestUserClientToken = data.requestUserClientToken ?? "";
      this.requestUserClientInfoData.fillData(data.requestUserClientInfoData);
